...
- The presenter UI already derives viewport signals in `adjustLayout()` using width/height thresholds and aspect ratio, setting `data-hmi-narrow`, `data-hmi-cramped`, and `data-hmi-tall`. These signals can be reused for auto-placement heuristics without inventing new thresholds. (clarksoft_hmi_presenter.js)
...
- /mnt/g/clarksoft/projects/hmi_presenter/src/clarksoft_hmi_presenter.js (retrieved 2026-01-19)
